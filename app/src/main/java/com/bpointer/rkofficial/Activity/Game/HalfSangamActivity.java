...
public class HalfSangamActivity extends AppCompatActivity implements View.OnClickListener, ItemClickListener {
   ImageView iv_back;
   CustomDialog customDialog;
   PreferenceManager preferenceManager;
   TextView tv_title, tv_wallet, tv_date, tv_change;
   EditText et_open_digit, et_point, et_close_digit;
   AutoCompleteTextView actv_close_panna, actv_open_panna;
   int company_id, game_id, userId, played_points = 0, wallet_amount = 0, dummy_wallet_amount = 0;
   String company_name, game_name, open_time, close_time, trigger = "odcp";
   Button bt_add, bt_submit;
   LinearLayout ll_close_digit_open_panna, ll_open_digit_close_panna;
         ...
         public void onResponse(Call<GetSingleDigitResponse> call, Response<GetSingleDigitResponse> response) {
            ...
            if (response.body() != null) {
               if (response.body().getStatus().equals("true")) {
                  ...
                  Toast.makeText(HalfSangamActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
               }
            }
         }
   ...
   private void initView() {
      ...
      et_open_digit = findViewById(R.id.et_open_digit);
      et_close_digit = findViewById(R.id.et_close_digit);
      actv_open_panna = findViewById(R.id.actv_open_panna);
      actv_close_panna = findViewById(R.id.actv_close_panna);
      bt_add = findViewById(R.id.bt_add);
      bt_submit = findViewById(R.id.bt_submit);
      ll_close_digit_open_panna = findViewById(R.id.ll_close_digit_open_panna);
      ll_open_digit_close_panna = findViewById(R.id.ll_open_digit_close_panna);
   ...
   public void onClick(View v) {
      switch (v.getId()) {
         ...
         case R.id.tv_change:
            if (trigger.equals("odcp")) {
               trigger = "cdop";
               ll_close_digit_open_panna.setVisibility(View.VISIBLE);
               ll_open_digit_close_panna.setVisibility(View.GONE);
            } else {
               trigger = "odcp";
               ll_open_digit_close_panna.setVisibility(View.VISIBLE);
               ll_close_digit_open_panna.setVisibility(View.GONE);
            }
            break;
         ...
         case R.id.bt_add:
            ...
            if (visibility_open) {
               if (trigger.equals("odcp")) {
                  if (tv_date.getText().toString().trim().equals("SELECT DATE")) {
                  ...
                  } else if (et_open_digit.getText().toString().isEmpty()) {
                     et_open_digit.setError("Open Digit Required !");
                     et_open_digit.requestFocus();
                     ...
                     String play = et_open_digit.getText().toString().trim() + "-" + actv_close_panna.getText().toString().trim();
                     insertGame(tv_date.getText().toString().trim(), play, et_point.getText().toString().trim());
                  }
               } else if (tv_date.getText().toString().trim().equals("SELECT DATE")) {
                  customDialog.showFailureDialog("Please Select Date");
               } else if (et_close_digit.getText().toString().isEmpty()) {
                  et_close_digit.setError("Close Digit Required !");
                  et_close_digit.requestFocus();
                  ...
                  String play = actv_open_panna.getText().toString().trim() + "-" + et_close_digit.getText().toString().trim();
                  insertGame(tv_date.getText().toString().trim(), play, et_point.getText().toString().trim());
               }
            } else {
   ...
   private void insertGame(String date, String play, String point) {
      ...
      if (alreadyPlayed) {
         customDialog.showFailureDialog("This Half Sangam already played!");
      } else {
         String type;
         if (trigger.equals("odcp")) {
            type = "2";
         ...
         String current_time = new SimpleDateFormat("HH:mm:ss", Locale.getDefault()).format(new Date());
         CartModel cartModel = new CartModel(userId, company_id, game_id, game_name, type, point, play, changeToServerDate(date), current_time);
   ...
   private void updateCart() {
      CartSangamAdapter cartSangamAdapter = new CartSangamAdapter(this, cartModelList, this, "Half Sangam");
      ...
      et_close_digit.setText("");
      et_open_digit.setText("");
      ...
      sweetAlertDialog.setTitleText(msg)
            ...
            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
               ...
               public void onClick(SweetAlertDialog sDialog) {
                  ...
                  Intent i = new Intent(HalfSangamActivity.this, MainActivity.class);
