...
public class SinglePannaActivity extends AppCompatActivity implements View.OnClickListener, ItemClickListener {
   ImageView iv_back;
         ...
         public void onResponse(Call<GetSingleDigitResponse> call, Response<GetSingleDigitResponse> response) {
            ...
            if (response.body() != null) {
               if (response.body().getStatus().equals("true")) {
                  ...
                  Toast.makeText(SinglePannaActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
               }
            }
         }
      ...
      int id = v.getId();
            ...
            if (visibility_open || visibility_close) {
               if (tv_date.getText().toString().trim().equals("SELECT DATE")) {
                  ...
                  actv_panna.setError("Single Panna Required ! !");
                  ...
                  actv_panna.setError("Invalid Single Panna !");
                  actv_panna.requestFocus();
      ...
      sweetAlertDialog.setTitleText(msg)
            ...
            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
               ...
               public void onClick(SweetAlertDialog sDialog) {
                  ...
                  Intent i = new Intent(SinglePannaActivity.this, MainActivity.class);
