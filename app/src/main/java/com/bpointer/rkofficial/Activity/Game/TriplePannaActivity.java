...
public class TriplePannaActivity extends AppCompatActivity implements View.OnClickListener, ItemClickListener {
   ImageView iv_back;
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      getTriplePannaNumbers();
      initView();
      startCountdownTimer();
      getSingleDigitDetails();
   }
   
   private void getTriplePannaNumbers() {
      ...
      for (int i = 100; i < 1000; i++) {
         ...
         if (first_digit.equals(second_digit) && first_digit.equals(third_digit)) {
         ...
         public void onResponse(Call<GetSingleDigitResponse> call, Response<GetSingleDigitResponse> response) {
            ...
            if (response.body() != null) {
               if (response.body().getStatus().equals("true")) {
                  ...
                  Toast.makeText(TriplePannaActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
               }
            }
         }
      ...
      int id = v.getId();
            ...
            if (visibility_open || visibility_close) {
               if (tv_date.getText().toString().trim().equals("SELECT DATE")) {
                  ...
                  actv_panna.setError("Triple Panna Required ! !");
                  ...
                  actv_panna.setError("Invalid Triple Panna !");
                  actv_panna.requestFocus();
      ...
      sweetAlertDialog.setTitleText(msg)
            ...
            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
               ...
               public void onClick(SweetAlertDialog sDialog) {
                  ...
                  Intent i = new Intent(TriplePannaActivity.this, MainActivity.class);
