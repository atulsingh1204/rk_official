...
public class DoublePannaActivity extends AppCompatActivity implements View.OnClickListener, ItemClickListener {
   ImageView iv_back;
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      getDoublePannaNumbers();
      initView();
      startCountdownTimer();
      getSingleDigitDetails();
   }
   
   private void getDoublePannaNumbers() {
      ...
      for (int i = 100; i < 1000; i++) {
         ...
         if (first_digit.equals(second_digit) || second_digit.equals(third_digit)) {
         ...
         public void onResponse(Call<GetSingleDigitResponse> call, Response<GetSingleDigitResponse> response) {
            ...
            if (response.body() != null) {
               if (response.body().getStatus().equals("true")) {
                  ...
                  Toast.makeText(DoublePannaActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
               }
            }
         }
      ...
      int id = v.getId();
            ...
            if (visibility_open || visibility_close) {
               if (tv_date.getText().toString().trim().equals("SELECT DATE")) {
                  ...
                  actv_panna.setError("Double Panna Required ! !");
                  ...
                  actv_panna.setError("Invalid Double Panna !");
                  actv_panna.requestFocus();
   ...
   private void insertGame(String date, String type, String panna, String point) {
      ...
      if (alreadyPlayed) {
         customDialog.showFailureDialog("This Panna already played!");
      } else if (prevType.equalsIgnoreCase(type)) {
         String current_time = new SimpleDateFormat("HH:mm:ss", Locale.getDefault()).format(new Date());
         CartModel cartModel = new CartModel(userId, company_id, game_id, game_name, type, point, panna, changeToServerDate(date), current_time);
      ...
      sweetAlertDialog.setTitleText(msg)
            ...
            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
               ...
               public void onClick(SweetAlertDialog sDialog) {
                  ...
                  Intent i = new Intent(DoublePannaActivity.this, MainActivity.class);
